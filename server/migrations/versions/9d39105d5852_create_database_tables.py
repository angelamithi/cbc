...
Revision ID: 9d39105d5852
Revises: 
Create Date: 2024-06-16 17:45:26.066196
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['school_id'], ['schools.id'], name=op.f('fk_terms_school_id_schools')),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['school_id'], ['schools.id'], name=op.f('fk_years_school_id_schools')),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['school_id'], ['schools.id'], name=op.f('fk_strands_school_id_schools')),
    ...
    sa.ForeignKeyConstraint(['school_id'], ['schools.id'], name=op.f('fk_substrands_school_id_schools')),
    ...
    sa.ForeignKeyConstraint(['school_id'], ['schools.id'], name=op.f('fk_learning_outcomes_school_id_schools')),
    ...
    sa.ForeignKeyConstraint(['school_id'], ['schools.id'], name=op.f('fk_assessment_rubics_school_id_schools')),
